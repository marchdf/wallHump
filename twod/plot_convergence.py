...
if __name__ == '__main__':
    ...
    for k, fdir in enumerate(fdirs):
        ...
        rdir = os.path.abspath(os.path.join(os.path.abspath(
            fdir), 'results_p{0:d}'.format(porder)))
        yname = os.path.join(os.path.abspath(
            fdir), 'wallHump_p{0:d}.i'.format(porder))
        u0, rho0, mu = parse_ic(yname)
