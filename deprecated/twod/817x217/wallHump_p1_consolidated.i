...
realms:
  ...
  - name: realm_1
    ...
    solution_options:
      ...
      options:
        ...
        - element_source_terms:
            ...
            turbulent_ke: [lumped_turbulent_ke_time_derivative, upw_advection_diffusion, lumped_sst]
            specific_dissipation_rate: [lumped_specific_dissipation_rate_time_derivative, upw_advection_diffusion, lumped_sst]
      ...
      specifications:
        - name: probe_bottomwall
          ...
          line_of_site_specifications:
            - name: results_p1_consolidated/probe_bottomwall
        ...
        - name: probe_profile0
          ...
          line_of_site_specifications:
            - name: results_p1_consolidated/probe_profile0
        ...
        - name: probe_profile1
          ...
          line_of_site_specifications:
            - name: results_p1_consolidated/probe_profile1
              number_of_points: 200
        ...
        - name: probe_profile2
          ...
          line_of_site_specifications:
            - name: results_p1_consolidated/probe_profile2
              number_of_points: 200
        ...
        - name: probe_profile3
          ...
          line_of_site_specifications:
            - name: results_p1_consolidated/probe_profile3
              number_of_points: 200
        ...
        - name: probe_profile4
          ...
          line_of_site_specifications:
            - name: results_p1_consolidated/probe_profile4
              number_of_points: 200
        ...
        - name: probe_profile5
          ...
          line_of_site_specifications:
            - name: results_p1_consolidated/probe_profile5
              number_of_points: 200
        ...
        - name: probe_profile6
          ...
          line_of_site_specifications:
            - name: results_p1_consolidated/probe_profile6
              number_of_points: 200
        ...
        - name: probe_profile7
          ...
          line_of_site_specifications:
            - name: results_p1_consolidated/probe_profile7
              number_of_points: 200
        ...
        - name: probe_profile8
          ...
          line_of_site_specifications:
            - name: results_p1_consolidated/probe_profile8
              number_of_points: 200
    ...
    - type: surface
      ...
      output_file_name: wallHump_p1_consolidated.dat
      frequency: 100
      parameters: [0,0]
      target_name: bottomwall

    output:
      output_data_base_name: results_p1_consolidated/wallHump.e
      output_frequency: 100
      output_node_set: no
      output_variables:
       - velocity
    ...
    restart:
      restart_data_base_name: restart_p1_consolidated/wallHump.rst
