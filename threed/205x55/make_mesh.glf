...
set _TMP(mode_2) [pw::Application begin ProjectLoader]
  $_TMP(mode_2) initialize {/Users/mhenryde/wind/wallHump/threed/205x55/hump2newtop_noplenumZ205x55_3D.pw}
...
set _TMP(mode_5) [pw::Application begin CaeExport [pw::Entity sort [list $_BL(1)]]]
  $_TMP(mode_5) initialize -strict -type CAE {/Users/mhenryde/wind/wallHump/threed/205x55/hump2newtop_noplenumZ205x55x50_3D.exo}
  $_TMP(mode_5) verify
  $_TMP(mode_5) write
$_TMP(mode_5) end
unset _TMP(mode_5)
